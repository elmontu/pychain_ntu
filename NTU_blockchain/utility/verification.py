...
class Verification:
    ...
    def verify_transaction(transaction, get_balance, check_funds=True):
        ...
        if check_funds:
            ...
            sender_balance_product = sender_balance.get(transaction.productID)
            print(sender_balance_product)
            return sender_balance_product >= transaction.amount  and Wallet.verify_transaction(transaction)
        else:
